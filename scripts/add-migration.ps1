...
$hostDirectory = $rootDirectory + '/src/Presentation/Eiromplays.IdentityServer/'
...
dotnet ef migrations add $commitMessage --project /src/Infrastructure/Migrators.SqlServer/ --context ApplicationDbContext -o Migrations/Application
...
dotnet ef migrations add $commitMessage --project /src/Infrastructure/Migrators.MySql/ --context ApplicationDbContext -o Migrations/Application
...
dotnet ef migrations add $commitMessage --project /home/eirik/GitHub/IdentityServer.Admin/src/Infrastructure/Migrators.PostgreSql/ --context ApplicationDbContext -o Migrations/Application
