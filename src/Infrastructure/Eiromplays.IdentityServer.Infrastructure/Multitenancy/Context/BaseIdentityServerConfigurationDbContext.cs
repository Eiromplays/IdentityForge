...
public class BaseIdentityServerConfigurationDbContext<TContext> : MultiTenantIdentityServerConfigurationDbContext<TContext>
    where TContext : DbContext, IConfigurationDbContext
{
    ...
    protected BaseIdentityServerConfigurationDbContext(ITenantInfo currentTenant, DbContextOptions<TContext> options, ICurrentUser currentUser,
