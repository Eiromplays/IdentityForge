...
public class EIATenantInfo : ITenantInfo
{
    public EIATenantInfo()
    {
    }

    public EIATenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
