...
public class BaseIdentityServerPersistedGrantDbContext<TContext> : PersistedGrantDbContext<TContext>
    where TContext : DbContext, IPersistedGrantDbContext
{
    ...
    protected BaseIdentityServerPersistedGrantDbContext(DbContextOptions<TContext> options, ICurrentUser currentUser,
