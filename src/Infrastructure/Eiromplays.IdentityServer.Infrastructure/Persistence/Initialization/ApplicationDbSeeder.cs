...
internal class ApplicationDbSeeder
{
    ...
    public ApplicationDbSeeder(
        ...
        IOptions<IdentityServerData> identityServerData)
    {
    ...
    private async Task AssignPermissionsToRoleAsync(ApplicationDbContext dbContext, IEnumerable<EiaPermission> permissions, ApplicationRole role)
    {
    ...
    private async Task SeedIdentityResourcesAsync(ApplicationDbContext dbContext)
    {
        ...
        {
            bool exits = await dbContext.IdentityResources.AsNoTracking().AnyAsync(a => a.Name == resource.Name);
    ...
    private async Task SeedApiScopesAsync(ApplicationDbContext dbContext)
    {
        ...
        {
            bool exits = await dbContext.ApiScopes.AnyAsync(a => a.Name == apiScope.Name);
    ...
    private async Task SeedApiResourcesAsync(ApplicationDbContext dbContext)
    {
        ...
        {
            bool exits = await dbContext.ApiResources.AsNoTracking().AnyAsync(a => a.Name == resource.Name);
    ...
    private async Task SeedClientsAsync(ApplicationDbContext dbContext)
    {
        ...
        {
            bool exits = await dbContext.Clients.AsNoTracking().AnyAsync(a => a.ClientId == client.ClientId);
