...
{
    Task<PaginationResponse<IdentityResourceDto>> SearchAsync(IdentityResourceListFilter filter,
        CancellationToken cancellationToken = default);

    Task<IdentityResourceDto> GetAsync(int identityResourceId, CancellationToken cancellationToken = default);

    Task UpdateAsync(UpdateIdentityResourceRequest request, int identityResourceId,
        CancellationToken cancellationToken = default);
